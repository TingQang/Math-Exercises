...
\begin{Answer}[ref={ex:ch03-04}]
    ...
    $\tan x - \sin x = \tan x(1 - \cos x) = \tan x \cdot 2\sin^2(\frac{x}{2})$，因此
    $\lim_{x \to 0} \frac{\tan x - \sin x}{x^3} = \lim_{x \to 0} \frac{\tan x \cdot 2\sin^2(\frac{x}{2})}{x^3} = \lim_{x \to 0} \frac{x \cdot 2 \cdot (\frac{x}{2})^2}{x^3} = \frac{1}{2}$
\end{Answer}
